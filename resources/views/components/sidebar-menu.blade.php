        ...
        <ul class="sidebar-menu">
            ...
            <li>
                <a href="{{ route('users.index') }}" class="navItem {{ (request()->is('users*')) ? 'active' : '' }}">
                    <span class="flex items-center">
                        <iconify-icon class=" nav-icon" icon="iconoir:group"></iconify-icon>
                        <span>{{ __('Usuarios') }}</span>
                    </span>
                </a>
            </li>
            <li>
                <a href="{{ route('products.index') }}" class="navItem {{ (request()->is('products*')) ? 'active' : '' }}">
                    <span class="flex items-center">
                        <iconify-icon class=" nav-icon" icon="iconoir:shop"></iconify-icon>
